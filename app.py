        ...
        "items": [
            {
                ...
                "bullets": [
                    ...
                    "针对采购成本开展方差分析和敏感性分析，识别主要成本影响因素及优化机会，为降本方案制定和业务决策提供数据依据，累计推动实现超过 80 万元人民币的成本节约。",
    ...
    "education": [
        {
            ...
            "location": "美国，大学城",
            "details": "GPA：3.4/4.0 | 相关课程：经济预测、数据挖掘、回归分析、数据库与大数据、金融数据分析",
        },
        {
            "school": "武汉理工大学",
            "degree": "物流管理学士",
            ...
            "location": "中国，武汉",
            "details": "GPA：3.2/4.0 | 奖项荣誉：校级三等奖学金（前13%）、院级三好学生（前30%）、“顺丰杯”物流创新大赛三等奖、“马钢杯”全国大学生物流设计大赛三等奖",
        },
    ],
}
