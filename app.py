        ...
        "items": [
            {
                ...
                "location": "中国武汉",
                "bullets": [
                    "负责搭建并维护 <strong>Power BI 与 Excel 业务分析仪表盘</strong>，对 <strong>采购计划执行进度、成本偏差 及供应商交付表现</strong> 等核心指标进行持续监控和分析，支撑月度经营复盘、<strong>业务洞察输出</strong> 及 <strong>数据驱动决策</strong>。",
                    "使用 <strong>SQL</strong> 和 <strong>Power Query</strong> 搭建集中化采购数据模型，打通 <strong>项目、零件、供应商、报价及成本</strong> 等多维业务数据，提升 <strong>数据整合效率、报表准确性</strong> 和 <strong>跨部门分析支持能力</strong>。",
                    "针对采购成本开展 <strong>方差分析</strong> 和 <strong>敏感性分析</strong>，识别主要成本影响因素及优化机会，为降本方案制定和业务决策提供数据依据，项目周期内累计推动实现 <strong>超过 80 万元人民币 的成本节约</strong>。",
                    "协同 <strong>采购、研发、物流和财务</strong> 等团队开展业务数据分析，支持 <strong>采购排期、交付安排 及 异常问题定位</strong>，为 <strong>跨部门协作</strong> 和业务决策提供数据支持。",
                    "承担临时性 <strong>数据分析 与 报告输出 工作</strong>，形成结构化分析结论，支持 <strong>审计 和 业务复盘</strong>，将文档返工率降低约 <strong>40%</strong>。",
                ],
            }
        ],
    },
